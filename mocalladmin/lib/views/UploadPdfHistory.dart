...
class UploadHistoryView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: UploadHistoryViewPage(),
    );
  }
}

class UploadHistoryViewPage extends StatefulWidget {
  const UploadHistoryViewPage({super.key});

  @override
  State<UploadHistoryViewPage> createState() => _UploadHistoryViewPageeState();
}

class _UploadHistoryViewPageeState extends State<UploadHistoryViewPage> {
