...
class PNPVIEW extends StatelessWidget {
  const PNPVIEW({super.key});

  @override
  Widget build(BuildContext context) {
    return MaterialApp(debugShowCheckedModeBanner: false, home: PNPPAGEVIEW());
  }
}

class PNPPAGEVIEW extends StatefulWidget {
  const PNPPAGEVIEW({super.key});

  @override
  State<PNPPAGEVIEW> createState() => _PNPPAGEVIEWState();
}

class _PNPPAGEVIEWState extends State<PNPPAGEVIEW> {
   final _databaseReference = FirebaseDatabase.instance.ref().child('messagehistory');
  ...
  void ViewMessageResponse(String datesubmit, String timesubmit, String message) {
    AwesomeDialog(
      context: context,
      width: 500,
                        ...
                        return DataRow(
                          cells: <DataCell>[
                            ...
                            DataCell(Row(
                              children: [
                                IconButton(
                                    icon: Icon(FontAwesomeIcons.solidEnvelope, color: Colors.green,),
                                    onPressed: () {
                                ...
                                IconButton(
                                  ...
                                  onPressed: () =>
                                      _showDeleteDialog(context, row['historyid']),
                                ),
                              ],
                            )),
                          ],
