...
import 'package:sawadmin/views/PNPHistoryView.dart';
import 'package:intl/intl.dart';
import 'dart:math';

class PNP extends StatelessWidget {
  const PNP({super.key});

  @override
  Widget build(BuildContext context) {
    return MaterialApp(debugShowCheckedModeBanner: false, home: PNPPage());
  }
}
...
class _PNPPageState extends State<PNPPage> {
  ...
  final _databaseReference =
      FirebaseDatabase.instance.ref().child('pnpmessage');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Row(
            children: [
              Image.asset("images/assets/policestation.png", width: 30),
              SizedBox(width: 5.0),
              Padding(
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => PNPVIEW()));
                },
              ),
              Divider(),
              ListTile(
